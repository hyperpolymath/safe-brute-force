...
;;; META.scm — safe-brute-force

(define-module (safe-brute-force meta)
...
(define development-practices
  '((code-style (languages . ("Erlang" "Just" "LFE" "Nix" "ReScript" "Rust" "Scheme" "Shell")) (formatter . "auto-detect") (linter . "auto-detect"))
