...
git clone https://github.com/hyperpolymath/safe-brute-force.git cd
safe-brute-force
...
toolbox create safe-brute-force-dev toolbox enter safe-brute-force-dev #
...
safe-brute-force/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
