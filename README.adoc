...
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/safe-brute-force"]
image:https://img.shields.io/badge/RSR-Bronze-cd7f32[RSR Compliance,link="RSR_COMPLIANCE.md"]
image:https://img.shields.io/badge/TPCF-P3_Community-green[TPCF Perimeter,link="MAINTAINERS.md"]
image:https://img.shields.io/badge/Erlang%2FOTP-26+-A90533?logo=erlang&logoColor=white[Erlang/OTP,link="https://www.erlang.org/"]
image:https://img.shields.io/badge/LFE-Lisp_Flavoured_Erlang-orange[LFE,link="https://lfe.io/"]
image:https://img.shields.io/badge/CI-GitLab_%7C_GitHub-blue[CI,link="https://github.com/hyperpolymath/safe-brute-force/actions"]
image:https://img.shields.io/badge/security.txt-RFC_9116-informational[Security,link=".well-known/security.txt"]
...
- *link:docs/SECURITY.md[Security Best Practices]*: Legal and ethical guidelines
- *link:docs/CONTRIBUTING.md[Contributing Guide]*: How to contribute
- *link:CLAUDE.md[CLAUDE.md]*: AI assistant guidance for development
...
We welcome contributions! Please see link:docs/CONTRIBUTING.md[CONTRIBUTING.md] for guidelines.

=== Contributors

- link:https://github.com/Hyperpolymath[Hyperpolymath] - Creator and maintainer
...
- *Issues*: link:https://github.com/Hyperpolymath/safe-brute-force/issues[GitHub Issues]
- *Discussions*: link:https://github.com/Hyperpolymath/safe-brute-force/discussions[GitHub Discussions]
- *Security*: See link:docs/SECURITY.md[SECURITY.md] for responsible disclosure
